...
//Create service member table
//This table differs from user table
//Table will be used to store service member data from CSV import
...
if($conn->query($sql) == TRUE){
    echo "Table `service_members` created sucessfully\n";
} else{
    echo "Error creating table: " . $conn->error;
}